...
int LoadGLTextures() // Load Bitmaps And Convert To Textures
{
	...
	if (TextureImage[0] = LoadBMP("Lab demos/Images/glass.bmp"))
	{
		...
		gluBuild2DMipmaps(GL_TEXTURE_2D, 3, TextureImage[0]->sizeX, TextureImage[0]->sizeY, GL_RGB, GL_UNSIGNED_BYTE,
		                  TextureImage[0]->data);
	}
...
void AnotherGlassCubeExample()
{
	// Press 'B' to enable/disable blending
...
void SimpleExample(float frontSquareAlpha)
{
	glDisable(GL_TEXTURE_2D);

	glTranslated(0, 0, -3);
	// front white square
	glColor4f(1, 0, 0, frontSquareAlpha);
	DrawSquare();
	// back blue square
	glColor4f(0, 0, 1, 1);
	DrawSquare(-2);
	// Press 'B' to dis/enable blending
	// With blending: making the front square full transparent will allow you to see the back one.
}
...
void SimpleExample2()
{
	...
	glTranslated(0, 0, -3);
	// play with alpha (0 transparent, 1 opaque)
	// front square
...
int DrawGLScene() // Here's Where We Do All The Drawing
{
	...
	// Press 'B' to enable/disable blending
	// play with alpha, try values between (0 transparent, 1 opaque)
	SimpleExample(0);

	// Press 'B' to enable/disable blending
	// play with alpha, try values between (0 transparent, 1 opaque)
	// AnotherGlassCubeExample();
