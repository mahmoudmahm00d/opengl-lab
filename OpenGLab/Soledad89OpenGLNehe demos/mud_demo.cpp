...
void SetupWorld()
{
	...
	FILE* filein;
	char oneline[255];
	filein = fopen("Soledad89OpenGLNehe demos/MudData/world.txt", "rt"); // File To Load World Data From
...
int LoadGLTextures() // Load Bitmaps And Convert To Textures
{
	...
	char c[] = "Soledad89OpenGLNehe demos/MudData/Mud.bmp";
                   ...
                   int nCmdShow) // Window Show State
{
	...
	if (!CreateGLWindow(NULL, 640, 480, 16, fullscreen))
	{
