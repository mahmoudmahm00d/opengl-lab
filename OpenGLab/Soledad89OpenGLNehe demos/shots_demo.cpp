...
BOOL Initialize(GL_Window* window, Keys* keys) // Any OpenGL Initialization Goes Here
{
	...
	if ((!LoadTGA(&textures[0], "Soledad89OpenGLNehe demos/ShotsData/BlueFace.tga")) || // Load The BlueFace Texture
		(!LoadTGA(&textures[1], "Soledad89OpenGLNehe demos/ShotsData/Bucket.tga")) || // Load The Bucket Texture
		(!LoadTGA(&textures[2], "Soledad89OpenGLNehe demos/ShotsData/Target.tga")) || // Load The Target Texture
		(!LoadTGA(&textures[3], "Soledad89OpenGLNehe demos/ShotsData/Coke.tga")) || // Load The Coke Texture
		(!LoadTGA(&textures[4], "Soledad89OpenGLNehe demos/ShotsData/Vase.tga")) || // Load The Vase Texture
		(!LoadTGA(&textures[5], "Soledad89OpenGLNehe demos/ShotsData/Explode.tga")) || // Load The Explosion Texture
		(!LoadTGA(&textures[6], "Soledad89OpenGLNehe demos/ShotsData/Ground.tga")) || // Load The Ground Texture
		(!LoadTGA(&textures[7], "Soledad89OpenGLNehe demos/ShotsData/Sky.tga")) || // Load The Sky Texture
		(!LoadTGA(&textures[8], "Soledad89OpenGLNehe demos/ShotsData/Crosshair.tga")) || // Load The Crosshair Texture
		(!LoadTGA(&textures[9], "Soledad89OpenGLNehe demos/ShotsData/Font.tga"))) // Load The Crosshair Texture
	{
...
void Selection(void) // This Is Where Selection Is Done
{
	...
	PlaySound("Soledad89OpenGLNehe demos/ShotsData/shot.wav",NULL,SND_ASYNC); // Play Gun Shot Sound
...
// Note: you have to include HeHeGl.cpp in build
void DrawGlScene() // Draw Our Scene
{
